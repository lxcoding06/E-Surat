        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Registrasi Akun 🚀</h4>
              <p class="mb-4 text-center">Silahkan Daftarkan Akun Anda!</p>

              <form class="mb-3" action="<?= base_url('Auth/Registration') ?>" method="POST">
                <div class="mb-3">
